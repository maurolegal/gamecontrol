      ...
      >
        ...
        >
          ...
          <div className="relative z-10 flex flex-col items-center text-center">
            ...
            >
              <img
                src="https://res.cloudinary.com/dtygv4kfq/image/upload/v1778155123/logo_vbgexk.png"
        ...
        >
          ...
          >
            ...
            <div className="flex items-center gap-3">
              ...
              <span className="text-[11px]" style={{ color: 'rgba(255,255,255,0.3)' }}>o continúa con</span>
              <div className="h-px flex-1" style={{ background: 'rgba(255,255,255,0.07)' }} />
            </div>
              ...
              {[
                {
                  ...
                  svg: (
                    <svg viewBox="0 0 24 24" width="22" height="22">
                      <path fill="#EA4335" d="M5.27 9.76A7.08 7.08 0 0 1 19.07 12c0 .68-.06 1.34-.17 1.97H12v-3.73h7.44A7.1 7.1 0 0 0 5.27 9.76z"/>
                      <path fill="#FBBC05" d="M12 19.08a7.08 7.08 0 0 1-6.73-4.84l-3.16 2.43A11.13 11.13 0 0 0 12 23.08c2.97 0 5.68-1.1 7.73-2.89l-3.04-2.35A7.06 7.06 0 0 1 12 19.08z"/>
                      <path fill="#4285F4" d="M19.07 12c0-.68-.06-1.34-.17-1.97H12v3.73h3.98a3.36 3.36 0 0 1-1.45 2.13l3.04 2.35c1.79-1.66 2.8-4.1 2.8-6.24h-1.3z" opacity=".5"/>
                      <path fill="#34A853" d="M5.27 14.24A7.05 7.05 0 0 1 4.92 12c0-.78.13-1.54.35-2.24L2.11 7.33A11.13 11.13 0 0 0 .88 12c0 1.77.42 3.44 1.16 4.93l3.23-2.69z"/>
                    </svg>
                  ),
                },
                {
                ...
                },
                {
                  label: 'Steam',
                  svg: (
                    <svg viewBox="0 0 24 24" width="22" height="22" fill="#c6d4df">
                ...
                <motion.button
                  ...
                  whileHover={{ scale: 1.1, background: 'rgba(255,255,255,0.1)', borderColor: 'rgba(0,255,120,0.3)' }}
                  whileTap={{ scale: 0.93 }}
                >
                  {s.svg}
                </motion.button>
