...
class GestorVentas {
                ...
                try {
                    ...
                    if (resSesiones && resSesiones.success && Array.isArray(resSesiones.data)) {
                        ...
                        const rawData = resSesiones.data.filter(s => {
                            ...
                            if (est === 'anulada' || est === 'cancelada') return false;
                        ...
                        sesionesMapeadas = rawData.map(row => {
                            ...
                            return {
                                ...
                                totalGeneral: Number(row.total_general || row.totalGeneral || row.total || row.total_sesion || row.total_pagar || row.subtotal || 0),
                                finalizada: true,
                    ...
                    try {
                        ...
                        if (resVentas && resVentas.success && Array.isArray(resVentas.data)) {
                            ...
                            ventasTienda = ventasSoloTienda.map(v => {
                                ...
                                const totalGeneral = Number(v.total || v.total_general || v.total_pagar || v.subtotal || 0);
    ...
    calcularTotalSesion(sesion) {
        ...
        // Fallback directo a campos de la BD antes de recalcular
        const totalDirecto = Number(sesion.total || sesion.total_sesion || sesion.total_pagar || sesion.subtotal || 0);
