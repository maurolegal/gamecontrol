-- ===================================================================
-- ⚠️  DEPRECATED — DO NOT USE AS PRODUCTION SOURCE OF TRUTH  ⚠️
-- ===================================================================
-- Este archivo NO representa el esquema real de producción.
-- Fue generado durante el desarrollo inicial y está desfasado.
--
-- Discrepancias conocidas (ver docs/gamecontrol-baseline.md §15):
--   - configuracion es singleton (id=1, datos JSONB), no key-value
--   - faltan tablas: clientes, medios_pago, ventas, venta_items,
--     cierres_turno, cierre_turno_items
--   - sesiones falta cliente_id y monto_* (pagos divididos)
--   - RLS aplicada en producción difiere de la definida aquí
--   - CONTIENE CREDENCIALES ADMIN EN CLARO (líneas ~413-415)
--     → considerar comprometidas. NO usar esas credenciales.
--
-- Referencia autoritativa (generada en Sprint 0.1):
--   docs/database/production-schema.sql
--   docs/database/rls-policies.sql
--
-- Este archivo se conserva sólo como referencia histórica.
-- No ejecutar contra ninguna base de datos.
-- ===================================================================
