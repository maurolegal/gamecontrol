-- GAMECONTROL FASE 2B / 011 ROLLBACK
-- Restaura definiciones y grants del snapshot pre-011.
BEGIN;

DROP FUNCTION IF EXISTS public.rpc_require_context(text[],text,uuid);
DROP FUNCTION IF EXISTS public.rpc_require_product_items(jsonb);
...
REVOKE ALL ON FUNCTION public.admin_cambiar_password(text,text) FROM PUBLIC, anon, authenticated, service_role;
REVOKE ALL ON FUNCTION public.agregar_productos_sesion(uuid,jsonb,text) FROM PUBLIC, anon, authenticated, service_role;
REVOKE ALL ON FUNCTION public.ajustar_stock(uuid,integer,text,text) FROM PUBLIC, anon, authenticated, service_role;
REVOKE ALL ON FUNCTION public.anular_sesion(uuid,text,text) FROM PUBLIC, anon, authenticated, service_role;
REVOKE ALL ON FUNCTION public.aplicar_movimiento_stock(uuid,integer,text,text,text,uuid) FROM PUBLIC, anon, authenticated, service_role;
REVOKE ALL ON FUNCTION public.crear_usuario(text,text,text,text,jsonb) FROM PUBLIC, anon, authenticated, service_role;
REVOKE ALL ON FUNCTION public.devolver_venta(uuid,jsonb,text,text) FROM PUBLIC, anon, authenticated, service_role;
REVOKE ALL ON FUNCTION public.editar_sesion_admin(uuid,integer,integer,jsonb,text) FROM PUBLIC, anon, authenticated, service_role;
REVOKE ALL ON FUNCTION public.editar_venta(uuid,jsonb,text) FROM PUBLIC, anon, authenticated, service_role;
REVOKE ALL ON FUNCTION public.finalizar_sesion(uuid,text,numeric,numeric,numeric,numeric,numeric,text,text) FROM PUBLIC, anon, authenticated, service_role;
REVOKE ALL ON FUNCTION public.ingresar_mercancia(jsonb,text,text) FROM PUBLIC, anon, authenticated, service_role;
REVOKE ALL ON FUNCTION public.registrar_merma(uuid,integer,text,text) FROM PUBLIC, anon, authenticated, service_role;
REVOKE ALL ON FUNCTION public.registrar_venta_pos(jsonb,text,text,text,numeric,numeric,numeric,numeric,numeric,text,text) FROM PUBLIC, anon, authenticated, service_role;
GRANT EXECUTE ON FUNCTION public.admin_cambiar_password(text,text) TO PUBLIC;
GRANT EXECUTE ON FUNCTION public.admin_cambiar_password(text,text) TO anon;
GRANT EXECUTE ON FUNCTION public.admin_cambiar_password(text,text) TO authenticated;
GRANT EXECUTE ON FUNCTION public.admin_cambiar_password(text,text) TO service_role;
GRANT EXECUTE ON FUNCTION public.agregar_productos_sesion(uuid,jsonb,text) TO anon;
GRANT EXECUTE ON FUNCTION public.agregar_productos_sesion(uuid,jsonb,text) TO authenticated;
GRANT EXECUTE ON FUNCTION public.agregar_productos_sesion(uuid,jsonb,text) TO service_role;
GRANT EXECUTE ON FUNCTION public.ajustar_stock(uuid,integer,text,text) TO anon;
GRANT EXECUTE ON FUNCTION public.ajustar_stock(uuid,integer,text,text) TO authenticated;
GRANT EXECUTE ON FUNCTION public.ajustar_stock(uuid,integer,text,text) TO service_role;
GRANT EXECUTE ON FUNCTION public.anular_sesion(uuid,text,text) TO authenticated;
GRANT EXECUTE ON FUNCTION public.anular_sesion(uuid,text,text) TO service_role;
GRANT EXECUTE ON FUNCTION public.aplicar_movimiento_stock(uuid,integer,text,text,text,uuid) TO anon;
GRANT EXECUTE ON FUNCTION public.aplicar_movimiento_stock(uuid,integer,text,text,text,uuid) TO authenticated;
GRANT EXECUTE ON FUNCTION public.aplicar_movimiento_stock(uuid,integer,text,text,text,uuid) TO service_role;
GRANT EXECUTE ON FUNCTION public.crear_usuario(text,text,text,text,jsonb) TO PUBLIC;
GRANT EXECUTE ON FUNCTION public.crear_usuario(text,text,text,text,jsonb) TO anon;
GRANT EXECUTE ON FUNCTION public.crear_usuario(text,text,text,text,jsonb) TO authenticated;
GRANT EXECUTE ON FUNCTION public.crear_usuario(text,text,text,text,jsonb) TO service_role;
GRANT EXECUTE ON FUNCTION public.devolver_venta(uuid,jsonb,text,text) TO authenticated;
GRANT EXECUTE ON FUNCTION public.devolver_venta(uuid,jsonb,text,text) TO service_role;
GRANT EXECUTE ON FUNCTION public.editar_sesion_admin(uuid,integer,integer,jsonb,text) TO authenticated;
GRANT EXECUTE ON FUNCTION public.editar_sesion_admin(uuid,integer,integer,jsonb,text) TO service_role;
GRANT EXECUTE ON FUNCTION public.editar_venta(uuid,jsonb,text) TO authenticated;
GRANT EXECUTE ON FUNCTION public.editar_venta(uuid,jsonb,text) TO service_role;
GRANT EXECUTE ON FUNCTION public.finalizar_sesion(uuid,text,numeric,numeric,numeric,numeric,numeric,text,text) TO authenticated;
GRANT EXECUTE ON FUNCTION public.finalizar_sesion(uuid,text,numeric,numeric,numeric,numeric,numeric,text,text) TO service_role;
GRANT EXECUTE ON FUNCTION public.ingresar_mercancia(jsonb,text,text) TO anon;
GRANT EXECUTE ON FUNCTION public.ingresar_mercancia(jsonb,text,text) TO authenticated;
GRANT EXECUTE ON FUNCTION public.ingresar_mercancia(jsonb,text,text) TO service_role;
GRANT EXECUTE ON FUNCTION public.registrar_merma(uuid,integer,text,text) TO anon;
GRANT EXECUTE ON FUNCTION public.registrar_merma(uuid,integer,text,text) TO authenticated;
GRANT EXECUTE ON FUNCTION public.registrar_merma(uuid,integer,text,text) TO service_role;
GRANT EXECUTE ON FUNCTION public.registrar_venta_pos(jsonb,text,text,text,numeric,numeric,numeric,numeric,numeric,text,text) TO anon;
...
GRANT EXECUTE ON FUNCTION public.registrar_venta_pos(jsonb,text,text,text,numeric,numeric,numeric,numeric,numeric,text,text) TO service_role;
