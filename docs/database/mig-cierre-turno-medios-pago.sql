...
ALTER TABLE public.cierres_turno
  ...
  ADD COLUMN IF NOT EXISTS fondo_inicial NUMERIC(12,2) DEFAULT 0;
...
COMMENT ON COLUMN public.cierres_turno.fondo_inicial IS 'Fondo inicial de caja al abrir turno (apertura)';
